...
EMAIL_PORT = 587  # TLS requires 587, SSL requires 465
EMAIL_USE_TLS = True  # Enable TLS (Transport Layer Security)
EMAIL_USE_SSL = False  # Disable SSL (Secure Sockets Layer)
EMAIL_HOST_USER = 'grito276@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'ulccypeqqqneuows'